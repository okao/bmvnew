...
export default function Posts() {
  ...
  const fetchMorePosts = async (metaData: MetaData) => {
    ...
    const searchInputArea =
      document.getElementById('searchInputArea');
    ...
    <div className="text-center">
      ...
      {result.data ? (
        <Pagination
          ...
          nextPage={() =>
            fetchNextPosts(result?.metaData as MetaData)
          }
          previousPage={() =>
            fetchPreviousPosts(result?.metaData as MetaData)
          }
          lastPage={() =>
            fetchLastPosts(result?.metaData as MetaData)
          }
          firstPage={() =>
            fetchFirstPosts(result?.metaData as MetaData)
          }
          loadMore={() =>
            fetchMorePosts(result?.metaData as MetaData)
          }
        />
      ) : null}
